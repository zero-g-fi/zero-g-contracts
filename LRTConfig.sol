...
contract LRTConfig is ILRTConfig, AccessControlUpgradeable {
    ...
    /// @param zgETH_ zgETH address
    function initialize(address admin, address zgETH_) external initializer {
        UtilLib.checkNonZeroAddress(admin);
        UtilLib.checkNonZeroAddress(zgETH_);

        __AccessControl_init();
        _addNewSupportedAsset(LRTConstants.ETH_TOKEN, 100_000 ether);

        _grantRole(DEFAULT_ADMIN_ROLE, admin);

        zgETH = zgETH_;
        emit SetZgETH(zgETH_);
    }
    ...
    /*//////////////////////////////////////////////////////////////
                            SETTERS
    //////////////////////////////////////////////////////////////*/
    /// @dev Sets the zgETH contract address. Only callable by the admin
    /// @param zgETH_ zgETH contract address
    function setZgETH(address zgETH_) external onlyRole(DEFAULT_ADMIN_ROLE) {
        UtilLib.checkNonZeroAddress(zgETH_);
        zgETH = zgETH_;
        emit SetZgETH(zgETH_);
    }
